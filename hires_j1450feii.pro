function hires_j1450feii,redshift

   directoryname = '/Users/drupke/Box Sync/hizeahires/'
   gal = 'j1450'
   redshift = 0.782d
   readcol,directoryname+'spec/J1450_stitched_v1.txt', $
...
; Finding the index to fit over
   linefitreg=[3950,4650]
   lineplotreg=[3950,4650]
...
;
      argspltmultiplet: {smooth: 3,$
                         xran: [[3970,4040],[4160,4185],[4205,4250],[4580,4640]]},$
;
      galaxy: gal, $
      zsys_gas: redshift,$
