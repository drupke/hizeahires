function hires_j1713feii,redshift

   directoryname = '/Users/drupke/Box Sync/hizeahires/'
   gal = 'j1713'
   redshift = 0.577d
   readcol,directoryname+'spec/J1713_stitched_v1.txt', $
...
; Finding the index to fit over
   linefitreg=[3650,4150]
   lineplotreg=[3650,4150]
...
;
      argspltmultiplet: {smooth: 3,$
                         xran: [[3670,3710],[3720,3770],[4060,4110]]},$
;
      galaxy: gal, $
      zsys_gas: redshift,$
