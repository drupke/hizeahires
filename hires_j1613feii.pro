function hires_j1613feii,redshift

   directoryname = '/Users/drupke/Box Sync/hizeahires/'
   gal = 'j1613'
   redshift = 0.449d
   readcol,directoryname+'spec/J1613_stitched_v1.txt', $
...
; Finding the index to fit over
   linefitreg=[3200,3800]
   lineplotreg=[3200,3800]
...
;
      argspltmultiplet: {smooth: 3,$
                         xran: [[3200,3280],[3360,3410],[3410,3460],[3710,3780]]},$
;
      galaxy: gal, $
      zsys_gas: redshift,$
