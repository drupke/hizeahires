function hires_j1232feii,redshift

   directoryname = '/Users/drupke/Box Sync/hizeahires/'
   gal = 'j1232'
   redshift = 0.400d
   readcol,directoryname+'spec/J1232_stitched_v1.txt', $
...
; Finding the index to fit over
   linefitreg=[3250,3650]
   lineplotreg=[3250,3650]
...
;
      argspltmultiplet: {smooth: 3,$
                         xran: [[3270,3290],[3310,3350],[3600,3650]]},$
;
      galaxy: gal, $
      zsys_gas: redshift,$
