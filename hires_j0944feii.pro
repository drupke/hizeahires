function hires_j0944feii,redshift
...
;   linenames = ['FeII2599','FeII2382']
;   loglf = [2.793d,2.882d]
;   multwave = [2599.3959d,2382.0386d]
...
; Finding the index to fit over
   linefitreg=[3520,3930]
   lineplotreg=[3520,3930]
   contplotreg=[3500,4000]
...
;
      ...
      abs_fix: abs_fix,$
;
      argspltmultiplet: {xran: [[3520,3545],[3575,3600],[3895,3930]]},$
;
      galaxy: gal, $
      zsys_gas: redshift,$
