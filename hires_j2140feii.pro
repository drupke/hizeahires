function hires_j2140feii,redshift

   directoryname = '/Users/drupke/Box Sync/hizeahires/'
   gal = 'j2140'
   redshift = 0.751d
   readcol,directoryname+'spec/J2140_stitched_v1.txt', $
...
; Finding the index to fit over
   linefitreg=[3900,4575]
   lineplotreg=[3900,4575]
...
;
      argspltmultiplet: {smooth: 3,$
                         xran: [[3900,3970],[4080,4110],[4130,4180],[4500,4570]]},$
;
      galaxy: gal, $
      zsys_gas: redshift,$
