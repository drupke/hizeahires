function hires_j1506feii,redshift

   directoryname = '/Users/drupke/Box Sync/hizeahires/'
   gal = 'j1506'
   redshift = 0.608d
   readcol,directoryname+'spec/J1506_stitched_v1.txt', $
...
; Finding the index to fit over
   linefitreg=[3550,4250]
   lineplotreg=[3550,4250]
...
;
      argspltmultiplet: {smooth: 3,$
                         xran: [[3580,3630],[3740,3770],[3780,3840],[4130,4190]]},$
;
      galaxy: gal, $
      zsys_gas: redshift,$
